...
--  del .sql del baseline (tag 0000_nervous_norman_osborn). Si se regenera el
...
SELECT '2d6234c6c56ab5ce208f970492df691191950897f69be0815b6a494851149d9f', 1782588720972
WHERE NOT EXISTS (
  SELECT 1 FROM `__drizzle_migrations`
  WHERE `hash` = '2d6234c6c56ab5ce208f970492df691191950897f69be0815b6a494851149d9f'
);
