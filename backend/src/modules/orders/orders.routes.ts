...
router.post(
  ...
  [
    ...
    body('customerEmail').optional({ checkFalsy: true }).isEmail().withMessage('Email inválido'),
    body('customerCedula').optional({ checkFalsy: true }).notEmpty(),
    body('department').optional({ checkFalsy: true }).notEmpty(),
    body('municipality').optional({ checkFalsy: true }).notEmpty(),
    body('address').optional({ checkFalsy: true }).notEmpty(),
    body('neighborhood').optional({ checkFalsy: true }).notEmpty(),
    body('notes').optional(),
